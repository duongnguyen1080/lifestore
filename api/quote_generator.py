...
3. If the quote is attributed correctly to a philosopher but the exact work where the quote is excerpted cannot be verified or found, find a new quote which must be an actual excerpt from another philosopher’s or thinker's original work.
